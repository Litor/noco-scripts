...
var configWebpack = {
    ...
    resolve: {
        ...
        extensions: ['.js', '.vue'],
        alias: {
            components: _path2.default.resolve(__dirname + '/src/components'),
            statics: _path2.default.resolve(__dirname + '/src/statics')
        }
    },
...
_gulp2.default.task('webpack', function (cb) {
    cb();
    return _gulp2.default.src([__dirname + '/emptyEntry.js']).pipe((0, _vinylNamed2.default)()).pipe((0, _webpackStream2.default)(configWebpack, null, function () {
        if (_getArgs.localize) {
            setTimeout(function () {
